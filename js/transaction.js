...
async function showTransactionModal(transactionId = null) {
  ...
  function updateCategoryOptions() {
    ...
    if (currentType === "expense") {
      if (optgroups[0]) optgroups[0].style.display = "";
      if (optgroups[1]) optgroups[1].style.display = "none";
    } else {
      if (optgroups[0]) optgroups[0].style.display = "none";
      if (optgroups[1]) optgroups[1].style.display = "";
    }
  }
